...
var file_default_proto_rawDesc = []byte{
	...
	0x09, 0x72, 0x70, 0x63, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0x22, 0x0a, 0x0c, 0x48, 0x65,
	...
	,
...
var file_default_proto_goTypes = []interface{}{
	(*HelloRequest)(nil),  // 0: rpcServer.HelloRequest
	(*HelloResponse)(nil), // 1: rpcServer.HelloResponse
}
var file_default_proto_depIdxs = []int32{
	0, // 0: rpcServer.Hello.SayHello:input_type -> rpcServer.HelloRequest
	0, // 1: rpcServer.Hello.LotsOfReplies:input_type -> rpcServer.HelloRequest
	1, // 2: rpcServer.Hello.SayHello:output_type -> rpcServer.HelloResponse
	1, // 3: rpcServer.Hello.LotsOfReplies:output_type -> rpcServer.HelloResponse
...
func (c *helloClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rpcServer.Hello/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloClient) LotsOfReplies(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Hello_LotsOfRepliesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Hello_serviceDesc.Streams[0], "/rpcServer.Hello/LotsOfReplies", opts...)
	if err != nil {
		return nil, err
	}
...
func _Hello_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpcServer.Hello/SayHello",
	}
