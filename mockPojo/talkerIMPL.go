...
// Package mock_pojo is a generated GoMock package.
package mock_pojo
...
func (m *MockTalker) SayHello(word, role string) string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SayHello", word, role)
	ret0, _ := ret[0].(string)
	return ret0
}

// SayHello indicates an expected call of SayHello.
func (mr *MockTalkerMockRecorder) SayHello(word, role interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SayHello", reflect.TypeOf((*MockTalker)(nil).SayHello), word, role)
}
